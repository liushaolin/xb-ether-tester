...
void init_gui_info()
{
    ...
    if (scrn_width==1440 && scrn_height==900)
        ...
        char_font = create_font(gt_gui_size_scale_ref.cyChar*WIDTH_COEFFICIENT*7/8, "宋体", 1);
    char_font_2 = create_font(gt_gui_size_scale_ref.cyChar*7/8*WIDTH_COEFFICIENT, TEXT("宋体"), 1);
